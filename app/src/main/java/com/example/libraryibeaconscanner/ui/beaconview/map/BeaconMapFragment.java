...
import com.example.libraryibeaconscanner.ui.beaconview.BeaconViewFragment;
...
public class BeaconMapFragment extends BeaconViewFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Bitmap backgroundImage = BitmapFactory.decodeResource(getResources(), R.drawable.library_3rd_map, options);
